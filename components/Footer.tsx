      ...
      <div className="relative container mx-auto px-4">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-muted-foreground">
            <span>© {currentYear} Arcco. Todos os direitos reservados.</span>
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="#" className="hover:text-white transition-colors duration-200">LGPD</a>
            </div>
          </div>
          ...
          <div className="flex space-x-4">
            {socialLinks.map((social, index) => (
              <a
                key={index}
                href={social.href}
                className="w-10 h-10 rounded-full bg-white/5 border border-white/5 flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-white/10 hover:border-white/10 transition-all duration-300 cursor-pointer"
