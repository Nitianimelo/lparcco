...
const motorItems = [
    {
        ...
        title: 'Arcco Tera — Nosso Modelo',
        desc: 'O coração da plataforma é o Arcco Tera, nosso modelo proprietário treinado para o mercado brasileiro. Ele entende contexto de negócio, jargão local e APIs brasileiras — sem depender de modelos estrangeiros para as tarefas críticas.',
        blobColor: '#8b5cf6',
        blobColor2: '#d946ef',
    ...
    },
    {
        ...
        title: 'Análise de até 50 PDFs',
        desc: 'Envie contratos, relatórios, editais ou manuais — até 50 PDFs ao mesmo tempo. O Arcco Tera lê, cruza as informações, extrai dados específicos e entrega um resumo executivo ou planilha consolidada em segundos.',
        blobColor: '#3b82f6',
        blobColor2: '#06b6d4',
    ...
    },
    {
        ...
        title: 'Slides, Planilhas e Imagens',
        desc: 'Peça uma apresentação profissional, um Excel com fórmulas prontas, um relatório em PDF ou uma imagem para marketing — e receba o arquivo para download. Nada de copiar texto. A Arcco entrega o produto final.',
        blobColor: '#10b981',
        blobColor2: '#14b8a6',
